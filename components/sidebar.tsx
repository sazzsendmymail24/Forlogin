...
const Sidebar: NextPage<SidebarType> = ({
  ...
  return (
    <div
      className={`w-60 shadow-[0px_4px_103px_rgba(50,_50,_71,_0.01),_0px_4px_59px_rgba(50,_50,_71,_0.03)] rounded-2xl bg-white flex flex-col items-start justify-start p-4 box-border gap-[349.8px] text-left text-base text-colour-black font-title1-bold ${className}`}
    >
