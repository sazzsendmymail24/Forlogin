...
const RecentUsers1: NextPage<RecentUsers1Type> = ({ className = "", edit }) => {
  return (
    <div
      className={`rounded-32xl bg-white border-aliceblue-300 border-[1px] border-solid box-border flex flex-row items-center justify-center py-2 pl-3 pr-10 gap-[53px] max-w-full text-left text-base text-colour-gray font-title1-bold mq850:gap-[26px] mq850:flex-wrap ${className}`}
    >
      <Image
