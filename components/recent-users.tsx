...
const RecentUsers: NextPage<RecentUsersType> = ({
  ...
  return (
    <div
      className={`w-[1043px] h-[84px] rounded-32xl bg-white border-aliceblue-300 border-[1px] border-solid box-border flex flex-row items-center justify-between py-[9.5px] pl-[13px] pr-[41px] [transition-property:all] ease-[cubic-bezier(0.4,_0,_0.2,_1)] duration-[150ms] cursor-pointer text-left text-base text-colour-gray font-title1-bold ${className}`}
      data-acc-item
      data-acc-header
      data-acc-original
