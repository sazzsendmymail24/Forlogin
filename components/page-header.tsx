...
const PageHeader: NextPage<PageHeaderType> = ({ className = "", myPlan }) => {
  return (
    <header
      className={`self-stretch rounded-2xl bg-white flex flex-row items-center justify-between py-[15.5px] px-[18px] top-[0] z-[99] sticky gap-5 text-left text-14xl text-colour-black font-title1-bold ${className}`}
    >
      <h2 className="m-0 relative text-inherit leading-[140%] font-normal font-[inherit]">
        {myPlan}
      </h2>
      <div className="self-stretch w-[303px] flex flex-row items-center justify-start gap-2.5 text-smi">
